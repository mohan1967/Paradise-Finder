<!DOCTYPE html>
<head>
<title>Bubble My Page Visualization - http://www.google.com - using D3js.org</title>
<meta charset="utf-8">
<style>
...
var page_text='      SearchImagesMapsPlayYouTubeNewsGmailDriveMoreCalendarTranslateMobileBooksWalletShoppingBloggerFinancePhotosVideosEven more  Account OptionsSign inSearch settingsWeb History                  A faster way to browse the web     Install Google Chrome            Advanced searchLanguage tools 12 Tips to start the new school year  Advertising ProgramsBusiness Solutions+GoogleAbout Google  2013 - Privacy & Terms ';
//alert(page_text);
var diameter = 800 - 30,
    limit=5000,
    format = d3.format(",d"),
...
<div id="infobox" style="color:gray;font-size:14px;">[<span id="urlbox" style=""><a href="http://www.google.com" rel="nofollow" >http://www.google.com</a></span>], No of Characters:55455 , Number of words:<span id="countbox">3342</span></div>
...
<p></p><br>		
		<div>
Copy the code below and paste in any HTML page<br>
...
<a href="http://www.infocaptor.com/bubble_viz/googlecom.html">http://www.infocaptor.com/bubble_viz/googlecom.html</a> #seo #dashboards #visualization #beautiful #data
</body>
</html>